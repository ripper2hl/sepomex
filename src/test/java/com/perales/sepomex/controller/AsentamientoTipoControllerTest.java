...
public class AsentamientoTipoControllerTest {
    
    private static final String API_URL = "/v1/asentamientotipo/";
    ...
    public void buscarPorId() throws Exception {
        ...
        response.andExpect( content().contentType(MediaType.APPLICATION_JSON_UTF8) )
                ...
                .andExpect(jsonPath("$.nombre", is (  "asentamientoTipo" ) ) );
    ...
    public void guardar() throws Exception {
        ...
        String json = ow.writeValueAsString( asentamientoTipo );
        ResultActions response = mockMvc
    ...
    public void actualizar() throws Exception {
        AsentamientoTipo asentamientoTipo = new AsentamientoTipo();
        asentamientoTipo.setId(1);
        asentamientoTipo.setNombre("actualizar");
        asentamientoTipo.setSepomexClave("sepomexClaveActualizada");
        StringBuilder sb = new StringBuilder(API_URL);
        ObjectWriter ow = new ObjectMapper().writer().withDefaultPrettyPrinter();
        String json = ow.writeValueAsString( asentamientoTipo );
        ResultActions response = mockMvc
